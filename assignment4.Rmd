...
#We can look at this too get an idea of which components we should keep and which we should drop

plot(pca, type = "lines")
# I will choose PC1 PC2 since they have the highest sd and also takse up large propotio of variance.
```
...
#from the plot we can see that pc6 is highly correlated with mean_correct, if we drop pc6(which covers small variance in the previosu pca test), we will lose this important data point.
COR2 <- cor(D4)
pdf("correlation2")
